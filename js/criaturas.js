...
export const CRIATURAS = [
  {
    codigo: 'TAT01', nome: 'Couraça', especie: 'tatu', vida: 12, forca: 3,
    especial: {
  ...
  {
    codigo: 'SAP02', nome: 'Bocão', especie: 'sapo', vida: 11, forca: 3,
    especial: {
  ...
  {
    codigo: 'TAT03', nome: 'Ferrão', especie: 'tatu', vida: 12, forca: 3,
    especial: {
  ...
  {
    codigo: 'SAP04', nome: 'Salta', especie: 'sapo', vida: 10, forca: 4,
    especial: {
      nome: 'Pulo Duplo', dano: 8, cura: 0, roubo: false, escudo: false, recuo: 0,
      texto: '8 de dano direto',
    },
  },
  {
    codigo: 'TAT05', nome: 'Casco', especie: 'tatu', vida: 13, forca: 3,
    especial: {
  ...
  {
    codigo: 'SAP06', nome: 'Trovão', especie: 'sapo', vida: 11, forca: 3,
    especial: {
      nome: 'Estouro', dano: 6, cura: 0, roubo: false, escudo: false, recuo: 2,
      texto: '6 de dano no oponente e 2 em você mesmo',
    },
  },
];
